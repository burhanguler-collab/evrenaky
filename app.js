...
const chapters = [
    ...
    { id: 'akademik_10_04', title: '10.4 Sınıf Sınıf Sonuçlar II: Cüceler ve Düzensizler (Sd–Im)', file: 'Metin/Akademik/Kisim_10_Yorunge_Dogrulamasi/04_Siniflar_Cuceler.md', group: 'akademik', part: 'Kısım X: Evrenakı Yörünge Doğrulaması' },
    { id: 'akademik_10_05', title: '10.5 Denetim Kümesi ve Uçlar: Karmaşık Küme, S0 ve BCD', file: 'Metin/Akademik/Kisim_10_Yorunge_Dogrulamasi/05_Denetim_ve_Uclar.md', group: 'akademik', part: 'Kısım X: Evrenakı Yörünge Doğrulaması' },
    { id: 'akademik_10_06', title: '10.6 Ölçek Bağıntıları: BTFR, Radyal İvme, Erken Tipler', file: 'Metin/Akademik/Kisim_10_Yorunge_Dogrulamasi/06_Olcek_Bagintilari.md', group: 'akademik', part: 'Kısım X: Evrenakı Yörünge Doğrulaması' },
    { id: 'akademik_10_07', title: '10.7 Türetim Zinciri: M_tut, mikro ℓ_ω, a₀’ın Biçimi', file: 'Metin/Akademik/Kisim_10_Yorunge_Dogrulamasi/07_Turetim_Zinciri.md', group: 'akademik', part: 'Kısım X: Evrenakı Yörünge Doğrulaması' },
    { id: 'akademik_10_08', title: '10.8 Eleme Zinciri: Açığın Anatomisi', file: 'Metin/Akademik/Kisim_10_Yorunge_Dogrulamasi/08_Eleme_Zinciri.md', group: 'akademik', part: 'Kısım X: Evrenakı Yörünge Doğrulaması' },
    { id: 'akademik_10_09', title: '10.9 SPARC Dışı Sınav: Yüksek Kırmızıya Kayma', file: 'Metin/Akademik/Kisim_10_Yorunge_Dogrulamasi/09_SPARC_Disi_Sinav.md', group: 'akademik', part: 'Kısım X: Evrenakı Yörünge Doğrulaması' },
