...
# Sadece Merkezcil İtim devrededir, formül: v = sqrt(A/r)
...
plt.plot(r_plot, model_evrenaki(r_plot, *popt_evrenaki), label='Evrenakı Merkezcil İtim ($v = \\sqrt{A/r}$ B=0)', color='#55aaff', linestyle=':', linewidth=3)
