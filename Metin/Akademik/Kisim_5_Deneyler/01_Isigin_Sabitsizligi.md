...
<div style="text-align: center; margin: 30px 0;">
    ...
    <p style="font-size: 0.9em; color: var(--text-muted); margin-top: 10px;"><em>Şekil 5.2: Ring Osilatör Deney Düzeneği. HFBR-53A5VEMZ fiber optik alıcı-verici ve frekans sayıcı kullanılarak tasarlanan, kütle yalıtımlı uzun süreli ölçüm sistemi.</em></p>
</div>
