...
| $\ell_\omega^{mikro}$ | **Vortisite uzunluğu** $= q_n/2\gamma_n$: nükleonun pulsasyon debisinin dolanım debisine oranı — **mikro sabittir.** $a_0=\mathcal{G}m_n/\ell_\omega^2$ bileşkesinin girdisi | **S** — ölçümü $35{,}7$ fm (133 galaksi; kütleyle korelasyon $+0{,}03$; saçılma 0,17 dex) | 6.5.4.3 Adım 6 |
