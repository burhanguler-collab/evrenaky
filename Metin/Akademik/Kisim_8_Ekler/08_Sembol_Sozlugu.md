...
| $q_n$ | **Nükleon başına pulsasyon hacim debisi** ($\omega_2$ pompasının kaynak şiddeti). $\alpha = Cq_n/4\pi m_n$ ile gradyan bağlaşım sabitini, dolayısıyla $G$'yi üretir | m³·s⁻¹, serbest (F) — $C$ ile tek kalem | **Ek M-35** |
