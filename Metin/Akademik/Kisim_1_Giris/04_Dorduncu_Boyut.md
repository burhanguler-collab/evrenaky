...
1. **Üç Boyutta İmkânsızlık Şartı:** Klasik mekanikte (3 boyutlu uzayda), yalıtılmış bir cismin eksen devinimi (yalpalama) yapması fiziksel olarak imkânsızdır. Açısal momentumun korunumu yasası gereği, dışarıdan harici bir kuvvet (tork) uygulanmadığı sürece dönen bir cismin ekseni sonsuza kadar sabit kalmak zorundadır.
2. **Dört Boyutta Doğallık Şartı:** Evrenakı teorisine göre ise devinimli dönme, dış bir kuvvetin eseri değil, dördüncü boyutu (W eksenini) içeren bir **"Çift Dönüş"ün en doğal, içsel ve kaçınılmaz üç boyutlu yansımasıdır.** 
