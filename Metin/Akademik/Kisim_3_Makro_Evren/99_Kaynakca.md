...
* Helmholtz, H. (1858). *Über Integrale der hydrodynamischen Gleichungen, welche den Wirbelbewegungen entsprechen*. Journal für die reine und angewandte Mathematik, 55, 25-55. (Vortex/Girdap teorisi).
* Hirt, C., Claessens, S., Fecher, T., Kuhn, M., Pail, R., & Woods, A. (2013). *New ultrahigh-resolution picture of Earth's gravity field*. Geophysical Research Letters, 40(16), 4279-4283. (GGMplus / GRACE-GOCE gravite verileri).
...
* Moritz, H. (1980). *Geodetic Reference System 1980*. Journal of Geodesy, 54(4), 395-405. (Kutup/Ekvator gravimetrik ivme standartları).
...
* Rubin, V. C., & Ford, W. K. (1970). *Rotation of the Andromeda Nebula from a Spectroscopic Investigation of Emission Regions*. The Astrophysical Journal, 159, 379-403. (Galaktik rotasyon eğrileri).
