# 3.8 Makro-Girdabın Motoru: Mikro'dan Makro'ya Vorteks Nedenselliği

Bölüm 3.4.4'te açılan soru — *"gezegenleri ve yıldız sistemlerini saran devasa Evrenakı girdaplarını ne döndürüyor?"* — bu bölümde Güneş Sistemi'nin gözlemsel verileriyle cevaplanır. Önce Güneş vorteksinin gezegen hızlarıyla kusursuz matematiksel uyumu kurulur (3.8.1) ve bu uyumun ürettiği Açısal Momentum Paradoksu çözülür (3.8.1.1); ardından nedensellik zinciri tersine çevrilerek teorinin evrensel motoru — 4. boyut mikro dönüşleri — ortaya konur (3.8.2) ve üç bağımsız gözlemsel kanıt ailesiyle sınanır (3.8.3–3.8.5). Bu çerçevenin en keskin sayısal sınavı olan Dünya-Ay hesabı, Bölüm 3.9.4'te verilecektir.

## 3.8.1 Güneş Vorteksi ve Gezegen Hızları Uyumu
...
## 3.8.2 Kuantum Dönüşleri ve Vorteks Nedenselliği (Nedenselliğin Tersinmesi)
...
## 3.8.3 Boyutlar Arası Yansıma Analojisi (3D Gölge Etkisi)
...
## 3.8.5 Asteroit Kuşağı Kanıtı: Kendi Girdabını Yaratan Kütleler
