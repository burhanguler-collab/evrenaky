...
<div style="background: #121212; padding: 20px; border-radius: 12px; border: 1px solid #404040; box-shadow: 0 10px 30px rgba(0,0,0,0.8); margin: 20px 0; text-align: center;">
  ...
  <iframe src="Metin/bolum_26_3d.html" width="100%" frameborder="0" style="height: 600px; min-height: 600px; border-radius: 8px; border: 1px solid #333; background: #050505;"></iframe>
</div>
