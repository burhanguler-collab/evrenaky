# Editör Notları (Yayın Metnine Girmeyecek İç Notlar)

*Bu dosya, bölüm metinlerinden çıkarılan yazar/editör inceleme notlarını saklar. Site menüsüne kayıtlı değildir; okuyucuya gösterilmez.*

## 3.10 Ay'ın Görmezden Gelinen Gizemleri — bölüm sonundan çıkarılan not (18.07.2026)

> [!WARNING]
> **Yazar/Editör İnceleme Notu (Açık Bilimsel Sorunlar ve Çelişkiler):**
> 
...
> 
> **3) Kitabın 8. Bölümü (Chapter 8) ile İç Çelişki:**
> Evrenakı'nın 8. Bölümünde düz dönüş eğrileri, süreklilik denklemi + kaçış hızı profili birleştirilerek $\rho(r) \propto r^{-3/2}$ yoğunluk profili türetilip "rejim-bağımlı kuvvet üst üste binmesi" ile açıklanmıştır. Buradaki (Bölüm 27) "kutupsal yanal sıkıştırma + statik arka plan basıncı" ise yoğunluk profilinden bağımsız, girdap geometrisinden gelen tamamen farklı bir mekanizma önermektedir. Manuskriptin kendi iç tutarlılığı için bu iki açıklamanın aynı fenomenin farklı yüzleri mi, yoksa birbiriyle çelişen post-hoc açıklamalar mı olduğu netleştirilmeli ve hangi rejimde hangisinin baskın olduğu çözülmelidir.
