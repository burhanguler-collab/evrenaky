# EvrenAKI Teorisi: Hakemlik Standartı ve Değerlendirme Kriterleri
...
## 1. İç Tutarlılık ve Terminoloji Disiplini
*   **Beklenti:** EvrenAKI kendine has bir kavramsal sözlüğe sahiptir (Zerre, Katar, Paket, Kütle-İtim). Hakem, bu kavramların kitabın başından (Mikro Evren) sonuna kadar (Makro Evren ve Galaktik rotasyonlar) anlam kaymasına uğramadan, tutarlı bir şekilde kullanılıp kullanılmadığını denetlemelidir.
*   **İhlal Durumu:** Bir bölümde "foton" denilerek standart modele dönülmesi veya "kütleçekimi" kelimesinin (eleştiri bağlamı dışında) bir kuvvet olarak zikredilmesi puan kırma sebebidir.

## 2. Tekil Mekanizma (Unification) ve Occam'ın Usturası
*   **Beklenti:** EvrenAKI'nin en büyük iddiası, standart bilimin "Karanlık Madde", "Karanlık Enerji" veya "Dalga Fonksiyonu Çökmesi" gibi birbirinden bağımsız *ad hoc* (duruma özel) yamalarla açıkladığı olayları, tek bir "kütle-itim vorteks" mekanizmasıyla çözmesidir. Hakem, sunulan çözümlerin gerçekten bu tekil mekanizmaya dayanıp dayanmadığını test etmelidir.
*   **İhlal Durumu:** Teorinin tıkanıp kendini kurtarmak için dışarıdan yeni bir "hayali parametre" ürettiğinin tespit edilmesi ciddi bir zafiyettir.

## 3. "Saman Adam" (Straw Man) Safsatasından Kaçınma
*   **Beklenti:** EvrenAKI, Standart Fiziğin yetersizliklerini eleştirirken nesnel olmalıdır. Hakem, metinlerde Standart Modelin argümanlarının (örneğin gezegen dönüşlerindeki açısal momentum, Görelilikteki Lense-Thirring etkisi vb.) çarpıtılıp çarpıtılmadığını kontrol etmelidir.
*   **İhlal Durumu:** "Standart fizik bunu bilmez, çaresizdir, mistik bir uydurmadır" tarzı polemik dillerinin kullanılması veya Standart Fiziğin aslında açıklayabildiği bir konunun "açıklanamıyor" gibi sunulması akademik etiğe aykırıdır ve raporlanmalıdır.

## 4. Dürüst Kayıt (Öz-Eleştiri) ve Sınırların Beyanı
...
---
**Puanlama Sistemi:**
Hakemlerin her kriteri 10 üzerinden değerlendirmesi, zayıf buldukları noktaları doğrudan yazarın düzeltmesi için somut (madde imli) önerilerle raporlaması beklenir. Amaç teoriyi yıkmak değil, onu akademik tartışma standartlarına yükseltecek pürüzsüzlüğe ulaştırmaktır.
