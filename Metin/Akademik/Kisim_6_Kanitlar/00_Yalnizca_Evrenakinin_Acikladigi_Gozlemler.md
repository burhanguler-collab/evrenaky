...
## 1. MİKRO EVREN, OPTİK VE KUANTUM OLGULARI

### 1.1 Çift Yarık Deneyi ve Tek Kenar Kırınımı Mekanizması
* **Standart Fiziğin Çıkmazı:** "Dalga-parçacık ikiliği" ve "bilinçli gözlemci ölçümüyle dalga fonksiyonunun soyut çökmesi".
* **Evrenakı Mekanik Çözümü:** Zerre (kütleli ışık parçacığı) katarının, yarığın veya kenarın çeperinde biriken yüksek yoğunluklu *Evrenakı Sınır Tabakası Gradyanı* ve kenar vorteksi ile yaptığı somut fiziksel temas mekaniği.
...
* **Evrenakı Mekanik Çözümü:** Işık sabitsizdir ($c=\sqrt{P/\rho}$). Zerre katarı cam gibi yüksek yoğunluklu ortama girdiğinde patinaj yaparak yavaşlar; camdan çıktığında ortamın yerel arka plan basıncına göre kendiliğinden sonik hızına ($c$) geri ulaşır.
...
### 3.2 Elektrik Yükünün ve Elektromanyetik Alanların Fiziksel Nedeni
* **Standart Fiziğin Çıkmazı:** Yük soyut bir $+/-$ kuantum sayısıdır; alanlar ise soyut kuvvet taşıyıcılarıdır.
* **Evrenakı Mekanik Çözümü:** Elektrik yükü; parçacık girdabının 4. Boyut ($W$ ekseni) dönüşünün 3D uzaydaki **4D Helisitesidir (sağ-el / sol-el tirbüşon akış burulması)**. Elektromanyetik alanlar ise ortama yayılan hidrodinamik dönü (vortisite) borulanmalarıdır.

### 3.3 Güçlü ve Zayıf Nükleer Kuvvetlerin Temas Mekaniği
* **Standart Fiziğin Çıkmazı:** Gluon ve W/Z bozonları ile taşınan bağımsız temel etkileşimler.
* **Evrenakı Mekanik Çözümü:** Femtometre ($r < r_c$) ölçeğinde nükleonların Evrenakı Rampalarının iç içe geçerek oluşturduğu **Rampa Kilitlenmesi ve Ortak Vakum Cebi**.

---

## 4. İKİLİ ÇÖZÜM TABLOSU (KARŞILAŞTIRMA MATRİSİ)

| Doğa Olgusu / Anomali | Standart Fizik Yaklaşımı | Evrenakı Teorisi Mekanik Çözümü |
|---|---|---|
...
| **Kozmolojik Kızıla Kayma** | Metrik genleşme veya Yorgun Işık | Geçmiş yüksek $c$ ortamında yayınlanma etkisi |
