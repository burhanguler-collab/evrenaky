...
* **Evrenakı Mekanik Çözümü:** Ortam iki kanaldan haber taşır. Basınç (dalga) kanalı $c_0$ ile çalışırken, ortamın yapısal düzenleme/topografya kanalı (Kohezyon kanalı) $v_m = c_0\sqrt{\Sigma/P_0}$ hızıyla ($v_m \gg c_0$) anında ayarlanır. Gizemli bir iletişim değil, tek okyanusun yapısal sürekliliğidir.
