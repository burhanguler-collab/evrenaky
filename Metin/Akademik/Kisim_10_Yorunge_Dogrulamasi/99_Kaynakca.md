# 10.11 Kaynakça ve Veri Referansları

Bu kısımdaki bütün dönüş eğrisi verileri, gözlemsel noktalar ve baryonik kütle hesapları, yayımlanmış hakemli literatürden **değiştirilmeden** alınmıştır. Hiçbir veri kümesine seçim (cherry-picking) uygulanmamış; yalnız veri kümelerinin kendi kalite bayrakları ($Q=3$, $i<30°$) süzgeç olarak kullanılmış ve süzgeçlerin kendisi yansızlık denetiminden geçirilmiştir (10.5).

## Temel veritabanı ve dönüş eğrileri (SPARC)

* **Lelli, F., McGaugh, S. S., & Schombert, J. M.** (2016). *SPARC: Mass Models for 175 Disk Galaxies with Spitzer Photometry and Accurate Rotation Curves.* The Astronomical Journal, 152(6), 157. [DOI: 10.3847/0004-6256/152/6/157] — bütün sınıf sınavlarının ham dönüş eğrileri (`Rotmod_LTG`), yüzey parlaklıkları ve ana katalog.

## Radyal ivme bağıntısı ve erken tip galaksiler

* **Lelli, F., McGaugh, S. S., Schombert, J. M., & Pawlowski, M. S.** (2017). *One Law to Rule Them All: The Radial Acceleration Relation of Galaxies.* The Astrophysical Journal, 836(2), 152. [DOI: 10.3847/1538-4357/836/2/152] — 10.6.2'nin 2693 ivme noktası ve 10.6.3'ün 16 erken tip galaksi halkası.

## Baryonik Tully-Fisher ilişkisi

* **Lelli, F., McGaugh, S. S., Schombert, J. M., Desmond, H., & Katz, H.** (2019). *The baryonic Tully-Fisher relation for different velocity definitions and implications for galaxy formation models.* MNRAS, 484(3), 3267–3278. [DOI: 10.1093/mnras/stz205] — 10.6.1'in farklı hız tanımlı BTFR kataloğu (`BTFR_Lelli2019.mrt`).

## Karanlık madde halo modelleri (ΛCDM karşılaştırmaları)

* **Li, P., Lelli, F., McGaugh, S. S., Pawlowski, M. S., Zwaan, M. A., & Schombert, J. M.** (2020). *A Comprehensive Catalog of Dark Matter Halo Models for SPARC Galaxies.* ApJS, 247(1), 31. [DOI: 10.3847/1538-4365/ab700e] — 10.10.1'in kod doğrulama referansı (`WP50_M200.mrt`).
* **Moster, B. P., Naab, T., & White, S. D. M.** (2013). *Galactic star formation and accretion histories from matching galaxies to dark matter haloes.* MNRAS, 428, 3121 — standart bilim öngörüsünün $M_*$–$M_{200}$ (abundance matching) ilişkisi.
* **Dutton, A. A., & Macciò, A. V.** (2014). *Cold dark matter haloes in the Planck era.* MNRAS, 441, 3359 — $c_{200}$–$M_{200}$ konsantrasyon ilişkisi.
* **Navarro, J. F., Frenk, C. S., & White, S. D. M.** (1996). *The Structure of Cold Dark Matter Halos.* ApJ, 462, 563 — NFW profili.

## Yüksek kırmızıya kayma diskleri
...
* **Chae, K.-H., Lelli, F., Desmond, H., McGaugh, S. S., Li, P., & Schombert, J. M.** (2021a). *Erratum: "Testing the Strong Equivalence Principle: Detection of the External Field Effect in Rotationally Supported Galaxies".* The Astrophysical Journal, 910(1), 81. — Tablo 2'nin düzeltilmiş $e_{\rm env}$ eşleşmesi; EFE sınavının veri kaynağı.
...
* **McConnachie, A. W.** (2012). *The Observed Properties of Dwarf Galaxies in and around the Local Group.* The Astronomical Journal, 144(1), 4. — Yerel Grup cüceleri derlemesi; M-48/M-49 dSph sınavının verisi.
* **Ponomareva, A. A., et al.** (2021). *MIGHTEE-HI: the baryonic Tully–Fisher relation over the last billion years.* Monthly Notices of the Royal Astronomical Society, 508(1), 1195–1205. — örneklem-dışı HI BTFR sınavının verisi.
* **Forbes, D. A., Alabi, A., Brodie, J. P., et al.** (2017). *The SLUGGS Survey: A Catalog of Over 4000 Globular Cluster Radial Velocities in 27 Nearby Early-type Galaxies.* The Astronomical Journal, 153(3), 114 (erratum: 2017, AJ, 154, 80). — eliptik dış-σ sınavının verisi (G-12).
