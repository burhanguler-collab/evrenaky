...
† *Öngörü yarışı (ΛCDM'e karşı galaksi başına), tablonun bütün sütunlarıyla aynı pencereli resmî kurulumla ölçülmüştür. Kazananı belirleyen metrik RMS'tir; RMS iç bölgenin yoğun örneklenmiş noktalarına daha çok ağırlık verir ve Evrenakı bu metrikte 87/141 ile öndedir. Örnekleme yoğunluğundan bağımsız ikinci metrikte — hata çubuğu içinde kalan nokta oranı — dağılım 65 üstün / 28 eşit / 48 geride'dir: teori 141 galaksinin 93'ünde bu metrikte de geride değildir.*
