...
SPARC Hubble tipi **T = 5, 6**. Kalite ve eğiklik süzgeçlerini geçen galaksiler.
...
|---|---|
| Galaksi sayısı | **30** |
| Toplam ölçüm noktası | 730 |
| Nokta / galaksi | 7 – 73 (medyan 20) |
| İçerdiği Hubble tipleri | Sc (T=5, n=14), Scd (T=6, n=16) |
| Kalite | Q=1 yuksek: 23 · Q=2 orta: 7 |
| Eğiklik | 38° – 90° (medyan 70°) |
