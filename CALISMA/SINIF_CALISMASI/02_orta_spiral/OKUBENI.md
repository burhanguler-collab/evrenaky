...
SPARC Hubble tipi **T = 3, 4**. Kalite ve eğiklik süzgeçlerini geçen galaksiler.
...
|---|---|
| Galaksi sayısı | **29** |
| Toplam ölçüm noktası | 640 |
| Nokta / galaksi | 7 – 50 (medyan 19) |
| İçerdiği Hubble tipleri | Sb (T=3, n=12), Sbc (T=4, n=17) |
| Kalite | Q=1 yuksek: 23 · Q=2 orta: 6 |
| Eğiklik | 46° – 90° (medyan 69°) |
