...
SPARC Hubble tipi **T = 1, 2**. Kalite ve eğiklik süzgeçlerini geçen galaksiler.
...
|---|---|
| Galaksi sayısı | **12** |
| Toplam ölçüm noktası | 632 |
| Nokta / galaksi | 13 – 115 (medyan 47) |
| İçerdiği Hubble tipleri | Sa (T=1, n=3), Sab (T=2, n=9) |
| Kalite | Q=1 yuksek: 6 · Q=2 orta: 6 |
| Eğiklik | 31° – 90° (medyan 54°) |
