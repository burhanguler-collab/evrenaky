...
SPARC Hubble tipi **T = 10**. Kalite ve eğiklik süzgeçlerini geçen galaksiler.
...
|---|---|
| Galaksi sayısı | **26** |
| Toplam ölçüm noktası | 272 |
| Nokta / galaksi | 6 – 31 (medyan 8) |
| İçerdiği Hubble tipleri | Im (T=10, n=26) |
| Kalite | Q=1 yuksek: 7 · Q=2 orta: 19 |
| Eğiklik | 32° – 80° (medyan 60°) |
