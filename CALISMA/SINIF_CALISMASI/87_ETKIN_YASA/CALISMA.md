...
| 26 | **YAYIN TEMİZLİĞİ + YZ BEYANI (kullanıcı kararları):** (a) kitap genelinde ~93 iç-yol referansı (CALISMA/ + defter dosyaları) kaldırıldı — CALISMA yayınlanmayacak; 10.1.7 haritasının dizin sütunu silindi; 6.5.5/10.10 beyanları 'arşivde saklı, talep edene açık' diline çevrildi. (b) Bölüm-içi 12 YZ damgası kaldırıldı; tek merkezî beyan eklendi: 1.1.4 (Claude+Gemini; matematiksel formülasyon + sayısal sınavlar + editoryal/akademik katkı; K9 raporları; teori bütünüyle yazarın eseri; akran denetimi şerhi). (c) 10.2.4 dipnotundaki doğrulanmamış '93/141 galip' düzeltildi (65 üstün/28 eşit/48 geride) | kitap |
| 25 | **GÜNCELLEME NOTLARI KALDIRILDI (kullanıcı kararı):** kitap henüz yayımlanmadığı için okuyucusuz değişiklik-günlüğü kafa karıştırır → 6.5.4.7(4b), 7.4 md.12(j), 10.2.6 md.3 ve 10.2.4 dipnotu temiz güncel-durum diliyle yeniden yazıldı; eski-biçim yarış sayıları (22/169-44/169; 4,91-2,49) kitaptan çıktı — TARİHÇE BU DEFTERDE DURUR (iş 22-24). Güncel aleyhte kayıtlar kitapta korundu (Sb-Sbc'de ΛCDM fit önde; 63/173'te δ>3σ_D) | kitap |
| 24 | **KİTAP UYARLAMASI (fit yeniden-tasarımı):** 10.1.1 tablosu (Υ*, δ_mesafe; a₀ kilitli; W δ-bağımsız) + not (medyan Υ*_fit 0,57; medyan δ 0,96; yarış 109/64; 63/173'te δ>3σ_D kaydı); 10.2.6 dürüstlük md.3 güncellendi (eski 44/169 kaydı DURUR + yeni biçimde dönüş); Popper paragrafı taze sayıyla (85/173, χ²≤2); 6.5.4.7(4b) ve 7.4 md.12(j)'ye güncelleme notları; 7.4'te 12,79/79-141 → 12,48/87-141 ve 0,113→0,115 düzeltmeleri | kitap |
| 23 | **δ SINIRI KALDIRILDI (adalet kararı, kullanıcı):** rakibin M₂₀₀ sınırının fiilen bağlamadığı ÖLÇÜLDÜ (8/173 galakside sınırda) → δ da serbest [0,2–5]. Dürüstlük kısıttan BİLGİYE taşındı: panelde δ'nın σ_D cinsinden sapması yazılıyor, >3σ kırmızı ⚠ (63/173 galakside aşıyor — kayıt). Serbest yarış sonucu: **Evrenakı fit 109 / ΛCDM fit 64**; sınıf medyan RMS'te E önde 6/7 (Sa dahil: 15,40 vs 15,47), yalnız Sb'de L önde (8,37 vs 8,64) | paneller |
| 22 | **FİT BİÇİMİ DEĞİŞTİ (dış-not önerisi, denetimli):** Evrenakı fiti (Υ*, a₀) → (Υ*, δ_mesafe), a₀ resmî değerde KİLİTLİ. Türetilen kilit özellik: g_kaps δ'dan bağımsız → W penceresi mesafe fitiyle HİÇ bozulmaz (v² = δ·[V_bar²+F4·W]). Dürüstlük kısıtı eklendi (Gemini'de yoktu): δ her galaksinin KENDİ katalog mesafe belirsizliğinin ±3σ bandında. Denetim sonuçları: fit yarışı TOPLAM E 94/173; sınıf medyan RMS'te E önde 4/7 (Sc,Sd,Sdm,Im), L önde 3/7 (Sa,Sb,99); Gemini'nin '16,04 ile ΛCDM'i yendik' sayısı sınırlı fitte DOĞRULANMADI (Sa: 16,82 vs 15,47); δ medyanları 0,80–1,15 — '+%27 sistematik' iddiası da doğrulanmadı, δ kısmen sınıf bandını emiyor (kayıt) | paneller |
| 21 | **PANEL FİT HATASI BULUNDU ve DÜZELTİLDİ (kullanıcı tespiti):** Evrenakı fitinin üst sınırı lb≤−1 idi; pencereli kalibrasyonda öngörü noktası lb₀=−0,996 SINIRIN DIŞINDA kalıyordu → fit F4 genliğine ulaşamıyor, 'öngörüden kötü fit' görüntüsü (Sd'de 16/16). Sınır açıldı + çok-başlangıçlı çözücü (bir başlangıç TAM öngörü noktası) → RMS kötü 1/173, χ² kötü 3/173 (N−k paydası). Fit katmanı (ef) panellere çentikli/varsayılan-kapalı geri kondu (teşhis aracı etiketiyle); Sb–Sbc teşhisi: Υ*_fit=0,526≈0,50 girdi doğrulandı, fit RMS 8,48 | paneller |
| 20 | **DIŞ-NOT DENETİMİ (Gemini) + sınıf sayfaları hizalaması:** (a) 03 sayfasına girmiş doğrulanmamış G1 dili/sayıları geri alındı; paneller iddiası YANLIŞ çıktı (sınıf panelleri M_kaps; g_bar yalnız belgeli vekil). (b) Asıl bulgu: 03/04/05 sayfaları + sinif_ongoru_vs_fit / s0_bcd / sinif_carpan_duzeltme betikleri PENCERE-ÖNCESİ kalibrasyonda kalmıştı → ×1,038+W geçirildi, yeniden koşuldu, öz-denetim GEÇTİ (0,050); sayfalar 10.2.4 ile birebir (yarış Sb–Sbc 18/29→22/29; Q=3 altküme 11/12→9/12; S0 ×2,61 RMS 34,9; BCD ×4,21; band 0,115 dex). (c) Popper paragrafı 10.2.6'ya ölçülü biçimde eklendi (mutlak 'unfalsifiable' DEĞİL — kendi 44/169 kaydımızla çelişirdi; 'risk asimetrisi + başarısızlık teoriye sayılmıyor' biçimi) + kaynakça | kitap |
| 19 | **10.2.6 AÇILDI — Teoriye Sadakat Karşılaştırması** (kullanıcı önerisi): hesap zincirinin kaynağı kıyası — Evrenakı zincirinde gözleme fitlenmiş halka 0; 'zincir' ΛCDM'de 2 halka fit-kökenli (abundance matching, c–M); pratik ΛCDM'de zincir yok (galaksi başına 2–3 fit — açıklanacak veri açıklamanın girdisi). Dürüstlük kayıtlarıyla: kapsam yalnız galaktik dinamik; eşit-serbestlik yarışında ΛCDM'in önde olduğu kayıt silinmedi. + 10.10.4 md.3 çapraz referans | kitap |
