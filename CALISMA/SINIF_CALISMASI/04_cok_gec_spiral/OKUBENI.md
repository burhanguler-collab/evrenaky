...
SPARC Hubble tipi **T = 7**. Kalite ve eğiklik süzgeçlerini geçen galaksiler.
...
|---|---|
| Galaksi sayısı | **16** |
| Toplam ölçüm noktası | 300 |
| Nokta / galaksi | 7 – 46 (medyan 16) |
| İçerdiği Hubble tipleri | Sd (T=7, n=16) |
| Kalite | Q=1 yuksek: 12 · Q=2 orta: 4 |
